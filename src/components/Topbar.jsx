...
export default function Topbar() {
  ...
  return (
    <>
      <div className="topbar" style={{ padding: '14px 28px', borderBottom: '1px solid #E8E6E0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0, gap: '12px', background: 'white', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
        ...
        <h3 className="topbar-raumname" style={{ fontFamily: "'Playfair Display', serif", fontSize: '18px', fontWeight: '500', color: '#2C2C2A', minWidth: '80px' }}>{activeRoom?.name}</h3>
        <div className="topbar-ansicht-desktop">{ansichtToggle}</div>
        <div style={{ flex: 1 }} />
      ...
      <div className="topbar-ansicht-mobil">{ansichtToggle}</div>
    </>
  )
}
